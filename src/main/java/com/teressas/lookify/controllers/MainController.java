package com.teressas.lookify.controllers;
...
import com.teressas.lookify.services.SongService;
...
public class MainController {
	...
	public String showCreateForm(@ModelAttribute("newSong")Song newSong) {
		return "createSongForm.jsp";
	}
	
	// Process Create Form
	@PostMapping("/songs/new")
	public String processCreateForm(@Valid @ModelAttribute("newSong") Song newSong,
